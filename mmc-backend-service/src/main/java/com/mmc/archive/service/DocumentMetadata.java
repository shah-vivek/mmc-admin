...
public class DocumentMetadata implements Serializable {
    ...
    public static final String PROP_DOCUMENT_ALBUM_ID= "album-id";
    ...
    public DocumentMetadata(String fileName, Date documentDate, String personName , String albumId) {
        this(UUID.randomUUID().toString(), fileName, documentDate,personName,albumId);
    }
    
    public DocumentMetadata(String uuid, String fileName, Date documentDate, String personName , String albumId) {
        super();
        this.uuid = uuid;
    ...
    public DocumentMetadata(Properties properties) {
        this(properties.getProperty(PROP_UUID),
             ...
             properties.getProperty(PROP_DOCUMENT_ALBUM_ID));
    ...
    public Properties createProperties() {
        ...
        props.setProperty(PROP_DOCUMENT_ALBUM_ID,getAlbumId());
        return props;
    }
