...
public class Document extends DocumentMetadata implements Serializable {
    ...
    public Document( byte[] fileData, String fileName, Date documentDate, String personName, String albumId) {
        super(fileName, documentDate, personName,albumId);
    ...
    public Document(DocumentMetadata metadata) {
        super(metadata.getUuid(), metadata.getFileName(), metadata.getDocumentDate(), metadata.getPersonName() , metadata.getAlbumId());
    }
    ...
    public DocumentMetadata getMetadata() {
        return new DocumentMetadata(getUuid(), getFileName(), getDocumentDate(), getPersonName(), getAlbumId());
    }
